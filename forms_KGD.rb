...
sdss_kgd_testing_production_fields = {
	...
	:end_time                => :timestamp,
	:probe_mark_check_result_(pass/fail) =>:boolean,
...
sdss_kgd_borrowing_machine_form_fields = {
    ...
    :procuction_line_check_machine_status    => :string,
    :eng_comment    => :string,
...
sdss_kgd_wafer_vacuum_packing_machine_first_sample_affirm_fields = {
	...
	:shift          => :string,
	:operator_id      => :string,
    :vacuum_time(8-11 sec)_vacuum_pressure(0.04-0.045 mpa)        => :float,
    :sealing_time(1.5-2.5 sec)       => :float,
    :cooling_time(3-6 sec)       => :float,
    :tech_signature     => :string,
    :qc_signature       => :string,
    :first_lot_affirm_(pass/fail)   => :boolean,
    :remark             => :string,
}
...
sdss_kgd_n2_cabinet_humidity_fields = {
    ...
    :shift         => :string,
    :op_id         => :string,
    :setup_humidity_(18% )    => :string,
    :actual_humidity          => :string,
    :check_result             => :boolean,
    :n2_valve_status(open/close)     => :string,
    :time                    => :timestamp,
    :pressurize_(yes/no)     => :boolean,
}
...
sdss_kgd_wafer_sorter_production_log_sheet_(cherry_pick)_fields = {
    :machine_no    => :string,
	:date          => :date,
    :shift         => :string,
    :op_id         => :string,
    ...
    :die_qty       => :string,
    :start_time    => :timestamp,
    :iqc_result_(pass/fail)                  => :boolean,
    :cherry_picking__result_(pass/fail)      => :boolean,
    :remark        => :string,
}
generate_form 'KGD_PRD', 'SdssKgdWaferSorterProductionLogSheet(CherryPick)',
...
sdss_kgd_wafer_vacuum_bag_use_fields = {
    ...
    :issue_request_qty_from_warehouse    => :string,
...
quality_deviation_notice_format_fields = {
    ...
    :defect_code    => :string,
    :potentially_affected_products_forword_2_sub_lots_and_backward_2_sub_lots => :string,
    :packgae  => :string,
    ...
    :others     => :string,
    :manufacturing_leader_ipqc_leader     => :string,
    ...
    :product_dispositon_ipqc_leader_mqe    => :string,
    :release_base_of_qc_buy_off_results_engineering_analysis_result     => :string,
    :hold_hold_affected_and_suspected_lots     => :string,
...
generate_form 'KGD_PRD', timestamp,
}'QualityDeviationNoticeFormat',
...
kgd_enginner_lot_n2_cabinet_fields = {
    ...
    :wafer_qty => :string,
    :work_status => :string,
    :reture_to_the_relate_member_ => :string,
}
