...
package_saw_shift_check_fields = {
	...
	:disco_chuck_table_area_bellows => :boolean,
...
generate_form 'BOP_EQP', 'SgnConversionKitChange',
...
generate_form 'BOP_EQP', 'SawSingulationBladeChange',
...
sgn_pm_monthly_half_year_fields = {
	:clean_every_station_of_system  => :boolean,
	:clean_all_motor_motion_status  => :boolean,
	:cheak_timing_blet              => :boolean,
	:check_clean_vacuum_pad_damage  => :boolean,
	:check_safe_door_and_interlock  => :boolean,
	...
	:clean_front_rear_of_SAW        => :boolean,
	:clean_the_lens_of_Saw_camera   => :boolean,
	:clean_drain_tank               => :boolean,
	:check_cylinder_and_connector   => :boolean,
	:check_spindle_cut_water_flow   => :boolean,
	:exchange_PCW_cool_water_filter => :boolean,
	:check_every_position_screw_nut => :boolean,
	:check_servo_motor_and_conn     => :boolean,
	:check_conn_of_every_station    => :boolean,
	:check_all_kinds_of_electric    => :boolean,
	:cheasn_the_exhaust_motor       => :boolean,
	:check_clean_screw_and_lubricat => :boolean,
	:buy_off                        => :boolean,
	:optical_inspection             => :boolean,
	:measure_5pcs_dummy_size_sawing => :boolean,
	:maintainer                     => :string,
	:confirm_by                     => :string,
}
generate_form 'BOP_EQP', 'SgnPmMonthlyHalfYear',
...
oven_shift_check_production_log_fields = {
	...
	:over_set_temp_protect_check   => :boolean,
	:sign                          => :string,
}
generate_form 'BOP_EQP', 'OvenShiftCheck',
...
generate_form 'BOP_EQP', 'OvenWeeklyPm',
...
generate_form 'BOP_EQP', 'LaserCutPositrol',
